...
public class SimpleVectorActions {
    ...
    public void processAndSaveText(String text) throws ExecutionException, InterruptedException {
        ...
        System.out.println("getEmbeddings::_>>>>>>>>>>>>>>>>>"+embeddings);
     ...
     * @throws InterruptedException if the thread is interrupted during execution
     */
    public void createCollection(String collection_name) throws ExecutionException, InterruptedException {
    ...
    public List<String> listCollection() throws ExecutionException, InterruptedException {
        List<String> result = qdrantClient.listCollectionsAsync().get();
        log.info("Collection was created: [{}]", result);
